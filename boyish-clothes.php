...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<?php echo asset('childish-girlish-clothes.css'); ?>">
    <link rel="stylesheet" href="<?php echo asset('girlish-clothes.css'); ?>">
    <script src="https://cdn.tailwindcss.com"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Boyish Clothes/Pink Shop</title>
</head>
...
<body class="">
        ...
        <div class="container">
            <nav class="header-nav-left"> <!--left navigation header-->
                ...
                <!-- <div class="classification">
                    <button class="classification">دسته بندی پوشاک</button>
                     دسته بندی پوشاک
                 </div> -->
            ...
            <nav class="header-nav-right"> <!--right navigation header-->
                ...
                <!-- <div class="enter-membership">
                      <p>
                      <a href="login.html">عضویت/ورود</a></p>
               </div> -->
                <div class="fa fa-profile">
                    <a href="<?php echo asset('myAccount.php'); ?>">
    ...
    <!--photoes of girlish and boyish baners-->
    <div class="photo-baners">
        <!--photoes of girlish baner-->
        <a href="<?php echo asset('girlish-clothes.php'); ?>" class="photoBanerGirlLink">
            <img src="<?php echo asset('./photoes/بنر پوشاک دخترانه.jpeg'); ?>" alt="" class="photoBanerGirl">
        </a>
        <!--photoes of boyish baner-->
        <a href="<?php echo asset('boyish-clothes.php'); ?>" class="photoBanerBoyLink">
            <img src="<?php echo asset('./photoes/بنر پوشاک پسرانه.jpeg'); ?>" alt="" class="photoBanerBoy">
        </a>
    </div>


    <!--boyish products title -->
    <section class="product">
        <h2 class="product-category">لباس های پسرانه</h2>
    </section>

    <hr class="hr1">

    <!-- boyish products : bloose title-->
    <section class="product1 product2">
        <h2 class="product-category">بلوز</h2>
    </section>

    <!--slides : boyish products -->
    <div class="product-container">
        ...
        <?php foreach ($posts as $post) { ?>
            ...
            <?php if ($post->category_id == 7) { ?>
                <!-- 32 in table subcategories means bloose -->
                <?php if ($post->subcategory_id == 32) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <!--girlish products title (t-shirt) -->
    ...
    <!--slides :boyish products (pants and shorts)-->
    <div class="product-container">

        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 7 means that boyish clothes in our query -->
            <?php if ($post->category_id == 7) { ?>
                <!-- 33 in table subcategories means shalvar and shortak -->
                <?php if ($post->subcategory_id == 33) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <!--girlish products title (boyish set) -->
    <section class="product1">
        <h2 class="product-category">
            ست ها
        </h2>
    ...
    <!--slides :boyish products (boyish set)-->
    <div class="product-container">
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 7 means that boyish clothes in our query -->
            <?php if ($post->category_id == 7) { ?>
                <!-- 34 in table subcategories means sets -->
                <?php if ($post->subcategory_id == 34) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <!--slides :boyish products (cup)-->
    <div class="product-container">
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 7 means that boyish clothes in our query -->
            <?php if ($post->category_id == 7) { ?>
                <!-- 35 in table subcategories means cups -->
                <?php if ($post->subcategory_id == 35) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <script src="<?php echo asset('childish-clothes.js'); ?>"></script>
</body>
