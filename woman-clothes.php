...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<?php echo asset('woman-clothes.css'); ?>">
    <script src="https://cdn.tailwindcss.com"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Woman page/Pink shop</title>
</head>
...
<body class="">
    ...
    <!--women products title -->
    <section class="product">
        <h2 class="product-category">لباس های زنانه</h2>
    </section>

    <hr class="hr1">

    <section class="product1 product2">
        <h2 class="product-category">مانتو</h2>
    </section>



    <!--slides : women products -->
    <div class="product-container">
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 6 means that women clothes in our query -->
            <?php if ($post->category_id == 6) { ?>
                <?php if ($post->subcategory_id == 28) { ?>
                    <!--product-->
    ...
    <!--women products title2 (paper clothes) -->
    <section class="product1">
        <h2 class="product-category">شومیز ها</h2>
    </section>



    <!--slides : women products paper clothes -->
    <div class="product-container">
    ...
    <hr class="hr1">
    <!--women products title2 (home set) -->
    <section class="product1">
        <h2 class="product-category">ست راحتی</h2>
    </section>

    <!--slides: women products title2 (home set)-->
    <div class="product-container">
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 6 means that women clothes in our query -->
            <?php if ($post->category_id == 6) { ?>
                <?php if ($post->subcategory_id == 30) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <hr class="hr1">
    <!--women products title (jeans) -->
    <section class="product1">
        <h2 class="product-category"> شلوار جین</h2>
    </section>

    <!--slides: women products (jeans)-->
    <div class="product-container">
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 6 means that women clothes in our query -->
            <?php if ($post->category_id == 6) { ?>
                <?php if ($post->subcategory_id == 31) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
    ...
    <script src="<?php echo asset('women-clothes.js'); ?>"></script>
