        ...
        <div class="container">
            <nav class="header-nav-left"> <!--left navigation header-->
                ...
                <!-- <div class="enter-membership">
                   <p>
                   <a href="login.php">عضویت/ورود</a></p>
            </div> -->
                <div class="fa fa-profile">
                    <a href="<?php echo asset('/myAccount.php'); ?>" title="پروفایل">
                ...
                <div class="fa fa-profile">
                    <a href="<?php echo asset('management-panel/index.php'); ?>" title="داشبورد مدیریت">
                        <i class="bi bi-person">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-justify" viewBox="0 0 16 16" style="color: #ffffff; margin-left:40px; margin-top:17px;" >
