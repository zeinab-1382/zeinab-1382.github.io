...
<head>
    ...
    <title>Girlish clothes/Pink Shop</title>
</head>
...
<body class="">
    ...
    <!--girlish products title -->
    <section class="product">
        <h2 class="product-category">لباس های دخترانه</h2>
    </section>

    <hr class="hr1">

    <!-- girlish products : dress title-->
    <section class="product1 product2">
        <h2 class="product-category">پیراهن</h2>
    </section>


    <!--slides : girlish products -->
    <div class="product-container">
        ...
        <?php foreach ($posts as $post) { ?>
            ...
            <?php if ($post->category_id == 8) { ?>
                <!-- 36 in table subcategories means t-shirt -->
                <?php if ($post->subcategory_id == 36) { ?>
                    <!--product-->
    ...
    <!--slides : girlish products (t-shirt)-->
    <div class="product-container">
        <!--product-->
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 8 means that girlish clothes in our query -->
            <?php if ($post->category_id == 8) { ?>
                <!-- 37 in table subcategories means t-shirt -->
                <?php if ($post->subcategory_id == 37) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <!-- <span class="discount-tag">50% off</span> -->
    ...
    <!--girlish products title (night dress) -->
    <section class="product1">
        <h2 class="product-category">
            لباس های مجلسی
        </h2>
    ...
    <!--slides : girlish products (night dress)-->
    <div class="product-container">
        <!--product-->
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 8 means that girlish clothes in our query -->
            <?php if ($post->category_id == 8) { ?>
                <!-- 38 in table subcategories means lebas majlesi -->
                <?php if ($post->subcategory_id == 38) { ?>
                    <!--product-->
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="product-thumb" alt="">
