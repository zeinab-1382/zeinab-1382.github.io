...
<head>
    ...
    <title>Childish clothes/Pink shop</title>
</head>
...
<body class="">
    ...
    <!--childish products title -->
    <section class="product">
        <h2 class="product-category">لباس های بچگانه</h2>
    </section>
    ...
    <!--girlish products title (girlish clothes) -->
    <section class="product1">
        <h2 class="product-category">
            <a href="<?php echo asset('girlish-clothes.php'); ?>">لباس های دخترانه</a>
        </h2>
    </section>
    ...
    <!--boyish products title (girlish clothes) -->
    <section class="product1">
        <h2 class="product-category">
            <a href="<?php echo asset('boyish-clothes.php'); ?>">لباس های پسرانه</a>
        </h2>
    </section>
    ...
    <div class="product-container">
        ...
        <!--product-->
        <?php foreach ($posts as $post) { ?>
            <!-- if category_id == 7 means that girlish-clothes in our query -->
