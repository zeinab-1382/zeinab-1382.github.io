...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<?php echo asset('men-clothes.css'); ?>">
    <script src="https://cdn.tailwindcss.com"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>men page/Pink shop</title>
</head>
...
<body class="">
    ...
    <section class="product">
        <h2 class="product-category">لباس های مردانه</h2>
    </section>
    ...
    <section class="product1">
        <h2 class="product-category">تیشرت</h2>
    </section>



    <!--slides : men products (t-shirt) -->
    <div class="product-container">
    ...
    <hr class="hr1">
    <!--women products title (pants) -->
    <section class="product1">
        <h2 class="product-category"> شلوار </h2>
    </section>


    <!--slides : men products (pants) -->
    <div class="product-container">
    ...
    <script src="<?php echo asset('men-clothes.js'); ?>"></script>
</body>
